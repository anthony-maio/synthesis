    ...
    def __init__(self, api_key: str, model: str = "claude-3-5-sonnet-20241022"):
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install synthesis-ai[providers]"
            )
...
class OpenRouterProvider(LLMProvider):
    ...
    def __init__(
        ...
        Args:
            ...
            model: Model to use (supports OpenRouter model routing)
...
class MockProvider(LLMProvider):
    ...
    async def complete(
        ...
        **kwargs: Any
        ...
        # Check for exact match or use default
        response = self.responses.get(prompt, "def mock():\n    return True")
